...
breakfast1 <- breakfast2[1:33,1:7]
...
breakfast22 <- breakfast2[keeps]

breakfast3 <- breakfast22[,1:5]
breakfast3$repdat <- breakfast22$`Baseline Resting Metabolic Rate (kcal/d)`
breakfast3$contrasts <- "T1"

breakfast4 <- breakfast22[,1:5]
breakfast4$repdat <- breakfast22$`Follow-Up Resting Metabolic Rate (kcal/d)`
